...
export function ListGamesByScore(){
    ...
    const sorteGames = allGames.sort((game1 , game2) => game2.score - game1.score);

    console.log(products, 'PRODUTOS DO CARRINHO');

    return(
        <div>
            <p className="ml-28 mb-4 text-white font-bold mt-8 headerMobile:ml-0 headerMobile:mb-2 headerMobile:mt-8">JOGOS COM SCORE MAIS ALTO</p>
            <Slider {...settings}>
                {sorteGames.map(game => {
                    return(
                        <CardGame
